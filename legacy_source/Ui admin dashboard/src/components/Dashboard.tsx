...
import { recentReports, departments } from "../utils/mockData";
            ...
            <tbody>
              {recentReports.map((report, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <Badge className={`${priorityColors[report.priority]} border-0`}>
                      {report.priority}
                    </Badge>
                  </td>
                  <td className="px-6 py-4">
                    <span className="text-sm text-[#0F172A]/60">{report.timestamp}</span>
                  </td>
                  <td className="px-6 py-4">
                    <Badge className={`${statusColors[report.status]} border-0`}>
                      {report.status}
                    </Badge>
                  </td>
                  <td className="px-6 py-4">
                    <span className="text-sm text-[#0F172A]/60">{report.assignedTo}</span>
                  </td>
                  <td className="px-6 py-4">

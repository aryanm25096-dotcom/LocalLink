        ...
        <div className="min-h-screen bg-[#020617] text-white pb-24">
            ...
            <div className="px-6 my-6">
                <Link href="/citizen/report">
                    <button className="w-full py-4 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl font-bold text-lg text-white shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2 active:scale-[0.98] transition-all">
                        <Camera size={24} />
                        <span>Report in 5 Seconds</span>
                    </button>
                </Link>
            </div>
            ...
            <section className="px-6 mb-8">
                <h2 className="text-xs font-medium text-slate-400 mb-4 uppercase tracking-wider">Quick Access</h2>
            ...
            <section className="px-6">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xs font-medium text-slate-400 uppercase tracking-wider">Recent Reports</h2>
                </div>
